...
def check_image_with_aiornot(image_data: bytes) -> dict:
    ...
    # Endpoint v2/sync, được thiết kế để UPLOAD file
    ...
    # Gửi dữ liệu ảnh dưới dạng 'files' (multipart/form-data)
    ...
    try:
        ...
        logger.error(f"Lỗi khi gọi API AIorNot: {e}") # Lỗi API sẽ báo ĐỎ
        return None
...
def handle_photo(update: Update, context: CallbackContext) -> None:
    ...
    try:
        ...
        # API v2 trả về 'report' trực tiếp, không có 'data' bọc ngoài
        ...
        if report:
            ...
            if generator_info:
                try:
                    # Tìm generator có điểm 'confidence' cao nhất
            ...
            # Lỗi này xảy ra khi API trả về status 200 nhưng không có 'report'
